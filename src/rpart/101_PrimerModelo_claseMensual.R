...
dataset <- dataset[,clase_mensual:=ifelse(foto_mes==2021201,'ENERO','MARZO')]
# dataset <- dataset[,clase_mensual:=ifelse(foto_mes==2021203,'MARZO',clase_mensual)]
...
modelo  <- rpart(formula=   "clase_mensual ~ .-clase_ternaria",  #quiero predecir clase_ternaria a partir de el resto de las variables                 
