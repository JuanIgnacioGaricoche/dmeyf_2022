...
particionar  <- function( data,  division, agrupa="",  campo="fold", start=1, seed=335897 )
{
...
particionar( dataset, division=c(7,3), agrupa="clase_ternaria", seed= 335897 )  #Cambiar por la primer semilla de cada uno !
