...
ksemillas  <- c(335897, 679909, 320923, 629243, 659819) #reemplazar por las propias semillas
...
{
for( vmin_split  in  c( 1000, 800, 600, 400, 500)  )
{
for( vmin_bucket  in  c( 5, 10, 20, 40, 80, 160, 320, 480, 640 )  )
{
for( vcp  in  c( -1, -0.5, -0.25, -0.1, 0, 0.05, 0.1)  )
{    
