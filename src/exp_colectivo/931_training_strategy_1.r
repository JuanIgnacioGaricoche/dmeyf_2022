...
PARAM  <- list()
PARAM$experimento <- "EC_TS931_1"

PARAM$exp_input  <- "EC_FE9251"

PARAM$future       <- c( 202107 )

PARAM$final_train  <- c(201906, 201907, 201908, 201909, 201910, 201911, 201912, 202009, 202010, 202011, 202012, 202101)
PARAM$train$training     <- c(201906, 201907, 201908, 201909, 201910, 201911, 201912, 202009, 202010, 202011, 202012, 202101)
PARAM$train$validation   <- c( 202102 )
PARAM$train$testing      <- c( 202105, 201905 )
