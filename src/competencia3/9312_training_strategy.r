...
PARAM$final_train  <- c( 202009, 202010, 202011, 202012, 202101, 202102, 202103, 202104, 202105 ) # Meses sobre los que se entrena el modelo final

# Meses sobre la que se va a correr la BO
PARAM$train$training     <- c( 202007, 202008, 202009, 202010, 202011, 202012, 202101, 202102, 202103 ) # Meses donde entrena la BO
PARAM$train$validation   <- c( 202104 ) # Mes donde valida la BO
PARAM$train$testing      <- c( 202105 ) # Mes donde testea la BO
PARAM$train$undersampling  <- 1.0   # 1.0 significa NO undersampling ,  0.1  es quedarse con el 10% de los CONTINUA
PARAM$train$semilla  <- 335897
