...
PARAM$final_train  <- c( 202103, 202104, 202105 ) # Meses sobre los que se entrena el modelo final

# Meses sobre la que se va a correr la BO
PARAM$train$training     <- c( 202101, 202102, 202103 ) # Meses donde entrena la BO
