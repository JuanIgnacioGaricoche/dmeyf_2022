...
PARAM  <- list()
PARAM$experimento <- "FC_TS9320"

PARAM$exp_input  <- "FC_FE9251"

PARAM$future       <- c(  202109 )

PARAM$final_train  <- c(201901, 201902, 201903, 201904, 201905, 201906, 201907, 201908, 201909, 201910, 201911, 201912, 202001, 202002, 202011, 202012, 202101, 202102, 202103, 202104, 202105)
...
PARAM$train$semilla_sampling  <- 335897
PARAM$train$semilla_under     <- 335897
