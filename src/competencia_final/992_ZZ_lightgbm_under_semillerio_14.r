...
PARAM <- list()
PARAM$experimento <- "FCZZ9410_semillerio_ensamble_m10"
PARAM$exp_input <- "FC_HT9420"

# PARAM$modelos  <- 2
PARAM$modelo <- 10 # se usa el mejor de la OB, pero a futuro podria variar esto
PARAM$semilla_primos <- 335897
PARAM$semillerio <- 52 # ¿De cuanto será nuestro semillerio?
PARAM$indice_inicio_semilla <- 14
PARAM$indice_fin_semilla <- 26
